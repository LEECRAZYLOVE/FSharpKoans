...
*)
    ...
    [<Test>]
    let ``07 Shadowing`` () =       //a=42  b=11 c=25  
        let a = 21
        let b =
            let a = 8
            3 + a
   ...
   *)
    ...
    let ``08 An identifier pattern will match anything`` () =
        ...
        let y = "One" // replace with a string
        let z = 6 // replace with anything else!
    ...
    let ``09 A wildcard pattern will match anything`` () =
        ...
        let _ = "eight" // replace with a string
        let _ = 5.0 // replace with anything else!
        ()
